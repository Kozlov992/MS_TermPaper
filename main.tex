...
Размер оригинала - 194 КБ, разрешение - $1920\times 1080$ пикселя.
\begin{figure}[H]
    \begin{minipage}{.5\textwidth}
    \end{minipage}%
    \begin{minipage}{.5\textwidth}
      \centering
    \caption{Восстановленое изображение \\(50 компонент)}
    \includegraphics[width = 0.95\textwidth]{reconstructions/with_50comps_Herbert_von_Karajan.jpg}
    \label{fig:hvk_50}
    \hspace{8 mm}
    \caption{Восстановленое изображение \\(100 компонент)}
    \includegraphics[width = 0.95\textwidth]{reconstructions/with_100comps_Herbert_von_Karajan.jpg}
    \label{fig:hvk_100}
    \hspace{8 mm}
    \caption{Восстановленое изображение \\(200 компонент)}
...
\begin{figure}[H]
    ...
    \label{fig:mount_100}
    \hspace{8 mm}
    \caption{Восстановленое изображение \\(400 компонент)}
...
\begin{table}[H]
    ...
    \caption{Оценка сжатия второго рисунка}
    \label{tab:mount}
\end{table}
\section{Обсуждение}
\section*{Примечание}
